# src/backtester/strategies/registry.py
...
from backtester.strategies.anchor_reversion_fx_no_bracket import AnchorReversionFXNoBracket
...
REGISTRY: Dict[str, Type[Strategy]] = {
    ...
    "AnchorReversionFXNoBracket": AnchorReversionFXNoBracket,
}
