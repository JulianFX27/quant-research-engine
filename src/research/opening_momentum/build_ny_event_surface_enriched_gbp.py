...
DATASET_PATH = Path(
    "data/canonical/GBPUSD_M5_2014-01-01__2024-12-31__dukascopy_v2_clean.csv"
)

OUTPUT_PATH = Path(
    "results/research/opening_momentum/gbpusd/ny_event_surface_enriched_gbp.csv"
)
...
def main() -> None:
    print("Loading GBPUSD dataset...")
    df = load_dataset()

    print("Building enriched NY event surface for GBPUSD...")
