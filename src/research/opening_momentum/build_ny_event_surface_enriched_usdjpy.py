...
DATASET_PATH = Path(
    "data/canonical/USDJPY_M5_2014-01-01__2024-12-31__dukascopy_v2_clean.csv"
)
    ...
    for d in dates:
        ...
        for delay in ENTRY_DELAYS_MIN:
            ...
            for hold in HOLDING_PERIODS_MIN:
                ...
                rec[f"ret_fwd_{hold}m_from_{delay}m"] = (
...
def main() -> None:
    print("Loading USDJPY dataset...")
    df = load_dataset()

    print("Building enriched NY event surface for USDJPY...")
