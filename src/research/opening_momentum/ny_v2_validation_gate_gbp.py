...
OUTPUT_DIR = Path(
    "results/research/opening_momentum/gbpusd/ny_v2_validation_gate"
)
...
def main() -> None:
    ...
    print("\n=== GBPUSD NY V2 VALIDATION GATE — GLOBAL ===\n")
    print(global_table.to_string(index=False))

    print("\n=== GBPUSD NY V2 VALIDATION GATE — BY PERIOD ===\n")
    print(period_table.to_string(index=False))

    print("\n=== GBPUSD NY V2 VALIDATION GATE — YEARLY (cost=1.0 pip) ===\n")
