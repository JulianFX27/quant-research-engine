...
from src.live.mt5.trade_finalizer import TradeFinalizer
...
def main():
    ...
    try:
        ...
        n = fin.finalize_window(ftmo_day_id=ftmo_day_id, time_from_utc=t_from, time_to_utc=now)
        print("FINALIZED:", n)
